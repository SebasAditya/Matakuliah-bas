        ...
        $this->form_validation->set_rules(
            ...
            $this->form_validation->set_rules(
                ...
                if ($this->form_validation->run() == false) {
                    ...
                    //kata 'login' merupakan nilai dari variabel judul dalam array $datadikirimkan ke view aute_header
                ...
                if ($user) {
                    ...
                    if ($user['is_active'] == 1) {
                        ...
                        if ($password==$user['password']) {
                            ...
                            if ($user['role_id'] == 1) {
                                ...
                                if ($user['image'] == 'default.jpg') {
                                    $this->session->set_flashdata(
                                        'pesan', '<div class="alert alert-info alertmessage" role="alert">Silahkan Ubah Profile Anda untuk Ubah Photo Profil</div>');
                                    }
                                    redirect('user');
                                }
                            }
                            ...
                            $this->session->set_flashdata('pesan', '<div class="alert alert-danger alertmessage" role="alert">User belum diaktifasi!!</div>');
                            redirect('autentifikasi');
                        }
                    }
                    else {
